...
namespace FerrumModules.Engine
{
    public class FerrumEngine : Game
    {
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            var windowRectRotated = Rotation.RotatedRectAABB(windowDimensions, camera.AngleOffset, Vector2.Zero);

            var cameraBoxSize = new Vector2(windowRectRotated.Width, windowRectRotated.Height);
