...
namespace Crossfrog.Ferrum.Engine.Entities
{
    ...
    public class AnimatedSprite : Sprite
    {
        ...
        public AnimatedSprite(params SpriteAnimation[] animations)
        {
        ...
        public AnimatedSprite(string textureName, int tileWidth, int tileHeight, params SpriteAnimation[] animations)
            : base(textureName, tileWidth, tileHeight)
        {
            StartAnimation(animations);
        }
